...
public final class Simulator_opt7_manual_example {
    public static void main(final String[] args) {
        ...
        final String out_x = x(in_a, in_b, in_d, in_c) ? "1 " : "0 ";
    ...
    public static boolean x(final boolean a, final boolean b, final boolean d, final boolean c) { return 
or(or(or(and(or(a, b) , d) , a) , b) , c)      ; }
}
