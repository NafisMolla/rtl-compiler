...
public final class Simulator_cse0 {
    ...
    public static boolean z() { return 
true     ; }
    public static boolean x(final boolean a, final boolean b) { return 
or(a, b)      ; }
    public static boolean t(final boolean a, final boolean b, final boolean c) { return 
or(or(a, b) , c)      ; }
    public static boolean y(final boolean a, final boolean b) { return 
or(a, b)      ; }
    public static boolean r(final boolean c, final boolean b, final boolean a) { return 
or(or(c, b) , a)      ; }
}
