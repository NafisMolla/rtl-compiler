...
public final class Simulator_opt7_big2 {
    public static void main(final String[] args) {
        ...
        final String out_x = x(in_a, in_b, in_c, in_d, in_e) ? "1 " : "0 ";
    ...
    public static boolean x(final boolean a, final boolean b, final boolean c, final boolean d, final boolean e) { return 
or(or(or(and(and(a, b) , c) , and(and(d, c) , e) ) , and(or(or(b, c) , and(a, e) ) , or(c, b) ) ) , d)      ; }
}
