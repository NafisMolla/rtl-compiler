...
public final class Simulator_cse5 {
    ...
    public static boolean x(final boolean a, final boolean b, final boolean c, final boolean d) { return 
or(and(a, b) , and(c, d) )      ; }
    public static boolean y(final boolean e, final boolean f, final boolean b, final boolean a) { return 
or(and(e, f) , and(b, a) )      ; }
}
