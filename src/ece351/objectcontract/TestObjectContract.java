...
public final class TestObjectContract extends TestObjectContractBase {
	...
	/**
	 * Construct an object who's equals method alternates between returning true and
	 * false.
	 */
	@Override
	...
	/**
	 * Construct two SymmetryBreaker objects to show that symmetry of equality is
	 * violated.
	 */
	@Override
	SymmetryBreaker[] constructSymmetryBreakers() {

		final SymmetryBreaker[] res = new SymmetryBreaker[2];
		// accoring to the test this will return true
	...
	/**
	 * Construct three TransitivityBreaker objects to show that transitivity of
	...
	Object[] constructHashcodeConsistencyViolators() {
		...
		// the transivity equals funciton will make this return true, but hashcode will
		// be different because the objects are in different memory addresses
		final double epsilon6 = TestObjectContractBase.TransitivityBreaker.epsilon * 0.6d;
		result[0] = new TransitivityBreaker(epsilon6);
		result[1] = new TransitivityBreaker(epsilon6 * 2);
		return result;
